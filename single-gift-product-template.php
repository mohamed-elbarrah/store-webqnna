...
$related = do_shortcode('[gifts orderby="rand" not_in="'.$product_id.'"]');

if(current_user_can('administrator') || current_user_can('editor')){
    $tuning_button = '<a class="tuning-button" href="' . get_permalink() . '/?tuning' . '">ضبط البطاقة</a>';
}

$s = file_get_contents(QS_DIR . '/html/single-gift-product-template.html');
...
$s = str_replace('[tuning-button]', $tuning_button, $s);
